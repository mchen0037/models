...
SUBFOLDER = "im2/"
FILE_NAME = "Lattice\ Land\ -\ Revised"
FILE_LOCATION = PATH_TO_MODELS_FOLDER + SUBFOLDER + FILE_NAME + ".nlogo"
EXPECTED_ZIP_LOCATION = PATH_TO_MODELS_FOLDER + SUBFOLDER + FILE_NAME + ".zip"
